#include <stdio.h>
/*promedio de sueldos.
El programa, al recibir como datos seis sueldos de un empleado, calcula tanto 
el ingreso total como el promedio mensual.
...
void main(void)
{
	...
	printf("ingrese la clase del empleado y los sueldos: \n");
